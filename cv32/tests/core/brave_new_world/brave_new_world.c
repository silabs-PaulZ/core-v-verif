...
volatile int glb_expect_ebreak_handler;
extern void _trigger_test(int i);
...
int main(int argc, char *argv[])
{
    ...
    // Special hanlder.S needed
    glb_expect_ebreak_handler = 1;
    printf("\nexpect ebreak = %0d\n",glb_expect_ebreak_handler);
    asm volatile("ebreak");
    printf("expect ebreak = %0d\n",glb_expect_ebreak_handler);
    if(glb_expect_ebreak_handler != 0 ){
      printf("EBREAK ERROR!\n");
      return EXIT_FAILURE;
    }
